...
class VirtualDrummer final {
public:
    /** @brief Constructs the rhythm generator around the shared display, controls, and gate HAL. */
    VirtualDrummer(hal::OledDisplay& display, hal::ControlPanel& controls, hal::GateOutputDriver& gateOutputs);
...
private:
    friend struct VirtualDrummerTestAccess;
