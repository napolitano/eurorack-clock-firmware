...
IMPLEMENTATION_COMPANION_HEADERS = {
    ...
    "screensaver_make_music.cpp": "screensaver_renderer.h",
    "screensaver_labyrinth.cpp": "screensaver_renderer.h",
    "screensaver_starfield.cpp": "screensaver_renderer.h",
    "screensaver_fireworks.cpp": "screensaver_renderer.h",
