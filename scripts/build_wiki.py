...
PAGES = (
    ...
    WikiPage('docs/VCV_RACK.md', 'VCV-Rack-Trial-First', 'VCV Rack Trial First', 'Engineering'),
    ...
    WikiPage('docs/VCV_DEVELOPMENT.md', 'VCV-Plugin-Development', 'VCV Plugin Development', 'Development'),
