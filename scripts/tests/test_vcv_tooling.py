...
class VcvManifestTests(unittest.TestCase):
    ...
    def test_panel_is_generated_from_native_simulator_geometry(self) -> None:
        ...
        self.assertIn('"CLOCK", 12.0F', shell)
        self.assertNotIn('"ENC / PUSH"', shell)
        self.assertIn('"PLAY"', shell)
        self.assertIn('"/ PAUSE"', shell)
        self.assertIn('"IN 1"', shell)
        ...
        self.assertIn(">CLOCK</text>", panel)
        ...
        self.assertIn(">/ SYNC</text>", panel)
        self.assertIn(">IN 2</text>", panel)
        self.assertIn(">/ RST</text>", panel)
